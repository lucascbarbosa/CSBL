...
# os.system("csv2arff Input_data/RNASeq_AdverseEvent.csv Input_data/RNASeq_AdverseEvent.arff")

loader = Loader(classname="weka.core.converters.ArffLoader")
data = loader.load_file("Input_data/RNASeq_AdverseEvent.arff")
data.class_is_last()
...
with open(f"Top_Features/RNASeq_AdverseEvent_TOP{TOP}.csv", "w", newline="\n") as arquivo_csv:
